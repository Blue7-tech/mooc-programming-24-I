...
with open(student_info) as file1, open(exercise_data) as file2, open(exam_data) as file3:
    ...
    word4 = "tot_pts."
    word5 = "grade"
    print(f"{word:30}{word1:10}{word2:10}{word3:10}{word4:10}{word5:10}")
    for identifier in id_name:
        print(f"{id_name[identifier]:30}{id_exercises[identifier]:<10}{id_exercises[identifier]//4:<10}{id_exams[identifier]:<10}{id_exercises[identifier]//4 + id_exams[identifier]:<10}{grading((id_exercises[identifier]//4) + id_exams[identifier]):<10}") 